        ...
        <div className="w-screen bg-white">
            ...
            <div className="p-6 mt-20">
                ...
                <p className="mb-4 text-black">
                    We’d love to hear from you! Whether you have questions, feedback, or just want to say hello, there are many ways to reach us.
                </p>

                <h2 className="text-black text-xl font-semibold mt-6 mb-4">Reach Us By:</h2>
                ...
                <ul className="mb-6 space-y-2">
                    ...
                    <li className="text-black">
                        <strong>Email:</strong> <a href="mailto:tyeso@gmail.com" className="text-blue-500 hover:underline">tyeso@gmail.com</a>
                    </li>
                    <li className="text-black">
                ...
                <h2 className="text-black text-xl font-semibold mt-6 mb-4">Send Us a Message:</h2>
                <p className="mb-4 text-black">
