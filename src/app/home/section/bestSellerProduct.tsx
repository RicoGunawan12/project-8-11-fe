  ...
  return (
    <div className="relative flex w-full h-auto lg:h-screen bg-stone-800 justify-center items-center gap-6 overflow-x-auto px-4 lg:px-20 py-10">
      ...
      <div className="relative w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-center overflow-x-auto pl-4 lg:pl-12 pr-4 lg:pr-12" id="best-seller-products">
          {/* Content container */}
          ...
          <div className="w-full lg:w-3/5 flex flex-wrap lg:flex-nowrap justify-center lg:justify-start gap-6 lg:gap-12 z-10">
              ...
              <Link
                key={1}
                className="flex-shrink-0 w-full h-full sm:w-[150px] lg:w-[300px]"
                href={`/product/1`}
              >
                <Image
                  src={`${process.env.BACK_BASE_URL}/assets/product/AAAA/1735342724653-AAAA.png`}
                  width={400}
                  height={550}
                  alt="logo pic"
                ...
                <div className="bg-white py-6 px-10">
                  ...
                  <div className="text-black font-semibold">AAAA</div>
                  <div className="text-black">Rp. 10.000.000</div>
