...
const CreateProduct: React.FC = () => {
    ...
    const [variants, setVariants] = useState<ProductVariant[]>([
        { productSize: '', productColor: '', productPrice: '', productStock: '', productWeight: '', sku: '' }
    ]);
    ...
    const handleVariantChange = (
        ...
        if (field === 'productSize' || field === 'productColor') {
            ...
            const newKey = `${productName} - ${field === 'productSize' ? value : oldVariant.productSize} - ${field === 'productColor' ? value : oldVariant.productColor}`;
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            ...
            setVariants([{ productSize: '', productColor: '', productPrice: '', productStock: '', productWeight: '', sku: '' }]);
            setImages({});
    ...
    return (
        <div className="w-screen h-screen bg-white flex justify-around items-center p-6">
            ...
            <div className='w-9/12 h-full p-6 shadow-2xl rounded-2xl border-2 text-black overflow-y-auto'>
                <h1 className="text-2xl font-bold mb-6 flex justify-between">Create New Product<div className='cursor-pointer' onClick={() => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e: ChangeEvent<HTMLInputElement>) => setProductCategoryName(e.target.value)}
                                className="w-full p-2 border rounded"
                                required
                            />
                        </div>
                            ...
                            <div key={index} className="p-4 border rounded space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleVariantChange(index, 'productSize', e.target.value)}
                                            className="w-full p-2 border rounded"
                                            required
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleVariantChange(index, 'productColor', e.target.value)}
                                            className="w-full p-2 border rounded"
                                            required
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleVariantChange(index, 'productPrice', e.target.value)}
                                            className="w-full p-2 border rounded"
                                            required
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleVariantChange(index, 'productStock', e.target.value)}
                                            className="w-full p-2 border rounded"
                                            required
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => handleVariantChange(index, 'productWeight', e.target.value)}
                                            className="w-full p-2 border rounded"
                                            required
                                        />
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        >
                                            {images[`${productName} - ${variant.productSize} - ${variant.productColor}`]
                                                ? 'Change Image'
                                                : 'Upload Image'
                                            }
                                        </label>
                                    ...
                                    {/* Image Preview */}
                                    {imagePreview[`${productName} - ${variant.productSize} - ${variant.productColor}`] && (
                                        <div className="mt-2">
                                            <Image
                                                src={imagePreview[`${productName} - ${variant.productSize} - ${variant.productColor}`]}
